...
/**
 * <p>An input form element to be used with {@link SimpleFormDialog}</p>
 * <p>This is an EditText that can be used to enter text, email-addresses, numbers, passwords etc.
 * Optionally supports auto-complete behaviour using suggestions.</p>
 * <p>This will add a String to resource bundle containing the entered text.</p>
...
public class Input extends FormElement<Input, InputViewHolder> {
    ...
    /**
     * <p>Specify weather this input may contain only one of the suggestions provided.
     * If enabled, the EditText will show an error message if something else was entered. This
     * will only take affect if suggestions were set by any of the {@link Input#suggest} methods.</p>
